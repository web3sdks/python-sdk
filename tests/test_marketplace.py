...
from web3sdks.contracts import Marketplace, NFTCollection, Edition, Token
from brownie import accounts
import pytest
from web3sdks.types.currency import TokenAmount
from web3sdks.types.marketplace import NewAuctionListing, NewDirectListing
...
def marketplace(sdk: Web3sdksSDK, primary_account) -> Marketplace:
...
@pytest.fixture(scope="function")
def nft_collection(sdk: Web3sdksSDK) -> NFTCollection:
...
@pytest.mark.usefixtures("sdk")
@pytest.fixture()
def edition(sdk: Web3sdksSDK) -> Edition:
...
@pytest.mark.usefixtures("sdk")
@pytest.fixture(scope="function")
def token(sdk: Web3sdksSDK) -> Token:
    token = sdk.get_token(
