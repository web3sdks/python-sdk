...
from web3sdks.common.error import DuplicateFileNameException
from web3sdks.constants.urls import DEFAULT_IPFS_GATEWAY
...
def test_replace_gateway_urls(storage: IpfsStorage):
    ...
    other_storage = IpfsStorage(gateway_url="https://ipfs.web3sdks.com/ipfs/")
    downloaded = other_storage.get(upload)

    assert downloaded["svg"].startswith("https://ipfs.web3sdks.com/ipfs/")
