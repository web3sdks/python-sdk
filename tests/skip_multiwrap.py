...
from web3sdks.contracts import Multiwrap, NFTCollection, Edition, Token
...
from web3sdks.types.nft import EditionMetadataInput, NFTMetadataInput
...
def multiwrap(sdk: Web3sdksSDK, primary_account) -> Multiwrap:
...
@pytest.fixture(scope="function")
def nft_collection(sdk: Web3sdksSDK, multiwrap: Multiwrap) -> NFTCollection:
...
@pytest.mark.usefixtures("sdk", "multiwrap")
@pytest.fixture()
def edition(sdk: Web3sdksSDK, multiwrap: Multiwrap) -> Edition:
...
@pytest.mark.usefixtures("sdk", "multiwrap")
@pytest.fixture(scope="function")
def token(sdk: Web3sdksSDK, multiwrap: Multiwrap) -> Token:
    token = sdk.get_token(
