...
from web3sdks.contracts.edition import Edition
from web3sdks.contracts.token import Token
from web3sdks.types.contracts.signature import PayloadToSign1155
...
@pytest.fixture()
def edition(sdk: Web3sdksSDK, primary_account) -> Edition:
