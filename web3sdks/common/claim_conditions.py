...
from web3sdks.abi.drop_erc721 import IClaimConditionClaimCondition
...
from web3sdks.core.classes.sharded_merkle_tree import ShardedMerkleTree

from web3sdks.types.contracts.claim_conditions import (
    ClaimCondition,
