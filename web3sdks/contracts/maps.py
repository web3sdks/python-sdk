...
# from web3sdks.abi.token_erc1155.bytecode import bytecode as TOKEN_ERC1155_BYTECODE
# from web3sdks.abi.token_erc20.bytecode import bytecode as TOKEN_ERC20_BYTECODE
# from web3sdks.abi.token_erc721.bytecode import bytecode as TOKEN_ERC721_BYTECODE
from web3sdks.types.contract import ContractType
from web3sdks.contracts import (
    NFTCollection,
    Edition,
    Token,
    Marketplace,
