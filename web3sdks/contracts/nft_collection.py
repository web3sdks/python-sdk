...
from web3sdks.core.classes.erc_721_signature_minting import ERC721SignatureMinting
...
from web3sdks.types.settings.metadata import NFTCollectionContractMetadata
