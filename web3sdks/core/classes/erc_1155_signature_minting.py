...
from web3sdks.abi.token_erc1155 import ITokenERC1155MintRequest
from web3sdks.common.currency import normalize_price_value, set_erc20_allowance
from web3sdks.common.nft import upload_or_extract_uris
from web3sdks.common.sign import EIP712StandardDomain
...
from web3sdks.types.contracts.signature import (
    EIP712DomainType,
    MintRequest1155,
    PayloadToSign1155,
    PayloadWithUri1155,
