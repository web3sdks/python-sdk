...
from web3sdks.common.sign import EIP712Domain, sign_typed_data_internal
from web3sdks.constants.events import EventStatus, EventType

from web3sdks.core.classes.provider_handler import ProviderHandler
from web3.eth import TxReceipt
from eth_account.account import LocalAccount
from zero_ex.contract_wrappers.tx_params import TxParams
from web3sdks.types.contract import TContractABI
from web3sdks.types.events import SignatureEvent, TxEvent
...
class ContractWrapper(Generic[TContractABI], ProviderHandler):
    """
    The contract wrapper wraps an instance of a specific web3sdks contract ABI
    ...
    def __init__(
        ...
        :param contract_abi: ABI of the web3sdks contract to use
