...
from web3sdks.common.feature_detection import (
    fetch_contract_metadata_from_address,
)
from web3sdks.constants.urls import get_provider_for_network
from web3sdks.contracts import Marketplace
from web3sdks.contracts.custom import CustomContract
from web3sdks.contracts.edition_drop import EditionDrop
from web3sdks.contracts.nft_drop import NFTDrop
from web3sdks.contracts.multiwrap import Multiwrap
from web3sdks.core.auth.wallet_authenticator import WalletAuthenticator
from web3sdks.core.classes.contract_deployer import ContractDeployer
...
from web3sdks.contracts import Token, Edition, NFTCollection
...
class Web3sdksSDK(ProviderHandler):
    ...
    def from_private_key(
        ...
        sdk = Web3sdksSDK(network, signer, options)
        return sdk
