"""Generated wrapper for IWeb3sdksPrimarySale Solidity contract."""
...
# constructor for IWeb3sdksPrimarySale below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IWeb3sdksPrimarySaleValidator,
    )
except ImportError:

    class IWeb3sdksPrimarySaleValidator(Validator):  # type: ignore
...
class IWeb3sdksPrimarySale:
    """Wrapper class for IWeb3sdksPrimarySale Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IWeb3sdksPrimarySaleValidator = None,
    ):
        ...
        if not validator:
            validator = IWeb3sdksPrimarySaleValidator(
