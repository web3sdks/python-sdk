"""Generated wrapper for IWeb3sdksRoyalty Solidity contract."""
...
# constructor for IWeb3sdksRoyalty below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        IWeb3sdksRoyaltyValidator,
    )
except ImportError:

    class IWeb3sdksRoyaltyValidator(Validator):  # type: ignore
...
class IWeb3sdksRoyalty:
    """Wrapper class for IWeb3sdksRoyalty Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: IWeb3sdksRoyaltyValidator = None,
    ):
        ...
        if not validator:
            validator = IWeb3sdksRoyaltyValidator(
